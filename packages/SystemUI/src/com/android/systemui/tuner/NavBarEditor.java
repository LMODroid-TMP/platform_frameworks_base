...
import static com.android.systemui.navigationbar.NavigationBarInflaterView.SIZE_MOD_END;
import static com.android.systemui.navigationbar.NavigationBarInflaterView.SIZE_MOD_START;
import static com.android.systemui.navigationbar.NavigationBarInflaterView.WEIGHT_SUFFIX;
import static com.android.systemui.navigationbar.NavigationBarInflaterView.WEIGHT_CENTERED_SUFFIX;
import static com.android.systemui.navigationbar.NavigationBarInflaterView.LEFT;
...
public class NavBarEditor extends PreferenceFragment implements TunerService.Tunable,
    ...
    private void notifyChanged() {
        mPreview.onChange(NAV_BAR_VIEWS, mNavBarAdapter.getUri());
    }
    ...
    private static CharSequence getLabel(String button, Context context) {
        if (button.startsWith(HOME)) {
            ...
            return context.getString(R.string.navbar_editor_power);
        } else if (button.startsWith(VOLUME_UP)) {
