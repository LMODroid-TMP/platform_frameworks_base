...
public class NetworkTraffic extends TextView {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.Secure.getUriFor(
                    LMOSettings.Secure.NETWORK_TRAFFIC_POSITION),
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.Secure.getUriFor(
                    LMOSettings.Secure.NETWORK_TRAFFIC_AUTOHIDE),
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.Secure.getUriFor(
                    LMOSettings.Secure.NETWORK_TRAFFIC_UNITS),
                    false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.Secure.getUriFor(
    ...
    private void updateSettings() {
        ...
        mUnits = Settings.Secure.getInt(resolver,
                LMOSettings.Secure.NETWORK_TRAFFIC_UNITS, /* Mbps */ 1);
        ...
        mShowUnits = Settings.Secure.getInt(resolver,
                LMOSettings.Secure.NETWORK_TRAFFIC_SHOW_UNITS, 1) == 1;
